...
function Home() {
  ...
  return (
    <DefaultLayout>
      ...
      <div className="HomeContainer hidden">
        ...
        <div className="Article section reverse">
          ...
          <div className="TextContent">
            ...
            <RioTextButton text={t("home.readArticle")} onClick={handleClick} />
          </div>
        </div>
      </div>
    </DefaultLayout>
